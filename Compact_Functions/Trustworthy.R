Trustworthy=function(Orig,Embed,PointLab,k){
...
for(i in 1:length(SampIndVec)){
	...
	NotInClass=which(PointLab[SampIndVec]!=SampClass)
	

	#get their sub matrices
	SubOrig=Orig[SampIndVec[NotInClass],]
	SubEmbed=Embed[SampIndVec[NotInClass],]
